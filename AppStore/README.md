...
Version 1.0.0 (19), iOS 17+, iPhone/iPad. Bundle ID `me.unvalley.verve` and the non-consumable are registered in the UNV Studio team. See [TESTFLIGHT.md](TESTFLIGHT.md) for the current distribution state; the checklist below covers the public release too.
