...
Free download. Browse, save, annotate and review 50 fixed phrasal verbs and 50 fixed idioms, explore all 36 diagrams, and use Practice for free; Mountains and Ocean backgrounds and the New York and SF Pro phrase fonts are also free. One **Izzy Pro** non-consumable purchase unlocks all 3,020 expressions for browsing and spaced reviews, plus every background and phrase font. No subscription, countdown trial, or consumable credits. The 100 free IDs are in `AccessPolicy.swift`; catalog additions do not alter them.
