...
struct ParticleConcept: Identifiable, Hashable, Sendable {
    ...
    static let all: [ParticleConcept] = [
        ...
        .init(id: "by", japanese: "そばに・そばを通って", english: "Beside; passing close", japaneseExtension: "近さや通過を表します。手段・行為者などの意味は、それぞれの文で確かめます。", englishExtension: "Picture closeness or passing nearby. Uses for a method or an agent need their own context.", comparison: "past"),
        .init(id: "past", japanese: "そばを通って先へ", english: "Beside and then beyond", japaneseExtension: "何かの横を通り過ぎて、その先へ進む動きです。障害や嫌な経験を乗り越える意味へ広がります。", englishExtension: "The path goes beside something and continues beyond it, like getting past an obstacle or a bad experience.", comparison: "by"),
