...
struct PurchaseView: View {
            ...
            PaperPage {
                VStack(alignment: .leading, spacing: Spacing.lg) {
                    ...
                    if purchases.hasFullAccess {
                        ...
                        Text(japanese ? "3,008表現を、使える言葉に。" : "Make all 3,008 expressions yours.")
    ...
    private var comparison: some View {
        let rows: [(String, String, String)] = japanese
            ? [("学べる表現", "100", "3,008"), ("例文と日本語訳", "240", "5,549"), ("間隔をあけた復習", "100表現", "すべて"), ("背景", "2種", "\(TodayBackground.allCases.count)種"), ("フレーズのフォント", "2種", "\(PhraseTypeface.allCases.count)種"), ("フレーズの保存とメモ", "○", "○")]
            : [("Expressions", "100", "3,008"), ("Examples with meanings", "240", "5,549"), ("Spaced reviews", "100", "All"), ("Backgrounds", "2", "\(TodayBackground.allCases.count)"), ("Phrase fonts", "2", "\(PhraseTypeface.allCases.count)"), ("Saved phrases and notes", "Yes", "Yes")]
