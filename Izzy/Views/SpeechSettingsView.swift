    ...
    var body: some View {
        List {
            ...
            Section("More natural voices") {
                ...
                Text("In iOS Settings, open Accessibility → Read & Speak (Spoken Content on earlier iOS versions) → Voices → English. Download an Enhanced or Premium voice, then return to Izzy. Downloads may require Wi-Fi and storage space.")
