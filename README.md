...
2. On first launch, choose **1–50 new expressions per day** in **Daily learning**. Home shows your new-expression progress beside compact page controls. Recall the meaning, reveal the meaning and examples together in **Today's learning**, then choose Again / Hard / Good / Easy directly on Home. Due cards come first; the chosen new-expression allowance persists across sessions and restarts. Change it anytime by tapping the progress count or through **Settings → Learning plan**. Each answer shows its next interval. Meaning recall uses a separate SM-2-derived schedule from speaking practice. See [daily learning](docs/daily-learning.md).
