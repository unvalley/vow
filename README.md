...
The collection contains **3021 expressions**: 80 original meaning-specific lessons, 534 additions from the supplied 601-row CSV, 848 additional phrasal-verb lessons, and 1559 idiom lessons with two authored contexts each. The original lessons retain their 160 situations, IDs, explanations, and learning history. The 67 overlapping CSV rows appear under **More usage** in their existing phrase details. All CSV Japanese meanings, English meanings, and examples are retained; combined labels are normalized with searchable aliases. The 848 additional lessons cover everyday life, travel, digital tasks and work, with bilingual meanings, usage notes, editorial difficulty and dictionary references. See [the latest expansion record](docs/CATALOG-3021.md).
