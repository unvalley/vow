...
8. Save phrases and write personal examples in **Phrases**. **Stats** (the flame on Today) shows your current/best streak, the last seven days, today's goal, a month calendar (tap a day to see what you practiced) and the next seven days of meaning reviews. **Phrase notes** also offers the same rating row. Settings is the third tab. See [Stats](docs/stats.md) for counting rules and sources.
