        ...
        PaperPage {
            VStack(alignment: .leading, spacing: Spacing.lg) {
                ...
                if !purchases.hasFullAccess {
                    ProAppearanceNote(text: "Mountains and Ocean are free. Every background opens with Vow Pro.") { purchase = true }
                }
                Divider()
    ...
    var body: some View {
        PaperPage {
            VStack(alignment: .leading, spacing: Spacing.lg) {
                ...
                if !purchases.hasFullAccess {
                    ProAppearanceNote(text: "New York and SF Pro are free. Every font opens with Vow Pro.") { purchase = true }
                }
                Divider()
                VStack(alignment: .leading, spacing: Spacing.sm) {
...
private struct AppearanceChoiceTile<Canvas: View>: View {
    ...
    var body: some View {
        Button(action: select) {
            ...
            .accessibilityValue(isLocked ? Text("Vow Pro") : Text(verbatim: ""))
