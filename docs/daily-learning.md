...
plus every expression already answered today: answered cards stay in the deck in
the order they had at the start of the day, rating moves on to the next card, and
