...
The outlined wordmark is the approved master from `../Brand/vow-wordmark.svg`.
...
All phone images are real vow iOS Simulator captures, proportionally resized to
...
The mountain background is the same m wrona photograph used by vow, from
...
The three practice previews are rendered from `Vow/Resources/phrases.json` at
