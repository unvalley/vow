export const copy = {
  "en": {
    ...
    "faqs": [
      [
        ...
        "Phrasal verbs combine a verb with a small word, as in “bring up.” Idioms are expressions whose meaning goes beyond the individual words, as in “on the house.” Izzy helps you learn both through meanings, examples and practice."
      ],
      [
        "Who is Izzy for?",
    ...
    "features": [
      {
        ...
        "alt": "Izzy daily learning settings with 3 new expressions selected and other daily goals available"
      },
      {
        "image": "idiom-current",
        ...
        "alt": "Izzy phrase notes for on the house, showing the Japanese meaning and two highlighted examples"
      },
      {
        ...
        "alt": "Izzy review card with a revealed meaning, examples and four recall ratings"
      },
      {
        "image": "stats-current",
  ...
  "ja": {
    ...
    "faqs": [
      [
        "句動詞とイディオムって何ですか？",
        "句動詞はbring up（話題を持ち出す）のような、動詞と短い言葉の組み合わせ。イディオムはon the house（お店からのサービス）のように、単語をそのまま訳しただけではわからない表現です。Izzyでは意味・例文・練習を通して、両方を学べます。"
      ],
      [
        "どんな人に向いていますか？",
    ...
    "features": [
      {
        ...
        "alt": "1日の学習数に3表現が選ばれ、5・10・15・20表現も選べるIzzyの設定画面"
      },
      {
        "image": "idiom-current",
        "title": "意味だけでなく、使う場面まで。",
        "text": "日本語とやさしい英語の解説、自然な例文、ゆっくり聞ける音声。文の中で、表現の使い方をつかめます。",
        "alt": "on the houseの日本語訳と、表現がハイライトされた2つの例文を表示するIzzyの詳細画面"
      },
      {
        "image": "review-current",
        "title": "忘れかけた頃に、もう一度。",
        "text": "まずは意味を思い出してから、答えを確認。思い出せた度合いに合わせて、次の復習のタイミングが決まります。",
        "alt": "意味と例文を確認したあと、4段階で思い出せた度合いを選ぶIzzyの復習画面"
      },
      {
        "image": "stats-current",
        "title": "続けた分が、見えてくる。",
